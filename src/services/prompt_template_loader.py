...
PROMPT_ID_QA_ANSWER_V4 = "qa_answer_v4"
PROMPT_ID_CONVERSATION_RECALL = "conversation_recall"
...
_PROMPT_FILE_MAP = {
    ...
    PROMPT_ID_QA_ANSWER_V4: "qa_answer_v4.md",
    PROMPT_ID_CONVERSATION_RECALL: "conversation_recall_v1.md",

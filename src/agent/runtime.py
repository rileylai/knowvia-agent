        ...
        *,
        ...
        if conversation_transform:
            ...
            system = (
                ...
                "Use search_memory for saved personal context. Use search_memory when the "
                "answer may be an explicitly saved personal or project fact, including natural "
                "questions such as 'what database do we use?' that do not contain memory, "
                "remember, or saved keywords. Pass the user's full memory "
